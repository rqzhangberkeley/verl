...
def compute_policy_loss(old_log_prob, log_prob, advantages, eos_mask, cliprange,
    ...
    if use_doctor_grpo:
        ppo_kl = verl_F.masked_mean_doctor_grpo(-negative_approx_kl, eos_mask, max_tokens)
        pg_loss = verl_F.masked_mean_doctor_grpo(torch.max(pg_losses, pg_losses2), eos_mask, max_tokens)
