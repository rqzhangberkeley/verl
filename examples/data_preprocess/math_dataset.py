...
if __name__ == '__main__':
    ...
    instruction_following = "Let's think step by step and output the final answer within \\boxed{}." # RZ This instructin is different than that in the OpenR1's codebase.
